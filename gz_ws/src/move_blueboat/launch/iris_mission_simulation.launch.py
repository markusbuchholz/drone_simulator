...
def generate_launch_description():
    return LaunchDescription([
        ...
        ExecuteProcess(
            cmd=['env', 'LIBGL_ALWAYS_SOFTWARE=1', 'gz', 'sim', 'iris_runway.sdf'], 
           # cmd=['env', 'LIBGL_ALWAYS_SOFTWARE=1', 'gz', 'sim', 'rubicon.sdf'], 
           # cmd=['env', 'LIBGL_ALWAYS_SOFTWARE=1', 'gz', 'sim', 'yosemite_world.sdf'], 
